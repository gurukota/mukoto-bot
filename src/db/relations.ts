...
import { events, tickets, ticketTypes, selectedEventCategories, eventCategories, tblCustomFields, organisers, users, currencies, account, session } from "./schema.js";
...
export const selectedCategoriesRelations = relations(selectedEventCategories, ({one}) => ({
	event: one(events, {
